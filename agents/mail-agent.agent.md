---
name: mail-agent
description: Email and calendar specialist. Reads, drafts, sends, and organises email. Schedules and manages calendar events. All mail and calendar tasks go through this agent.
...
mcp-servers:
  mail-mcp:
    ...
    env:
      OUTLOOK_CLIENT_ID: ${{ secrets.COPILOT_OUTLOOK_CLIENT_ID }}
      OUTLOOK_CLIENT_SECRET: ${{ secrets.COPILOT_OUTLOOK_CLIENT_SECRET }}
      OUTLOOK_TENANT_ID: ${{ secrets.COPILOT_OUTLOOK_TENANT_ID }}
---
